...
import PaymentStat from "./components/admin/PaymentStat";
          ...
          <div className="App">
            ...
            <div className="container">
              ...
              <Switch>
                ...
                <PrivateRoute exact path="/packages" component={TourPackages} />
                <PrivateRoute
                  exact
                  path="/editpackage/:id"
                ...
                />
                <PrivateRoute exact path="/offers" component={OffersView} />
                <PrivateRoute
                  exact
                  path="/createoffer"
